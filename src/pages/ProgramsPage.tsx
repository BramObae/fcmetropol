...
import { PROGRAMS, ProgramFeatureBullet } from "@/components/site/programs-data";
      ...
      <div className="container-pro space-y-10 md:space-y-16">
        {PROGRAMS.map((p, idx) => (
          <article
            key={p.id}
            id={p.id}
            className="scroll-mt-28 grid lg:grid-cols-12 gap-6 md:gap-10 items-start glass-card rounded-3xl p-6 md:p-10"
          >
            ...
            <div className="lg:col-span-3 flex lg:flex-col gap-3 lg:items-stretch">

...
const AboutPage = () => {
  return (
    <>
      ...
      <section className="relative overflow-hidden pt-36 pb-24 md:pt-44 md:pb-32">
        ...
        <div className="container-pro relative z-10">
          <div className="max-w-5xl">
            ...
            {/* FLAGS CAROUSEL (TOP) */}
            <div className="relative overflow-hidden mb-10 marquee-wrap">
      ...
      {/* (Everything below stays EXACTLY same: leadership, mission, team, values) */}
...
export default AboutPage;import { SEO } from "@/components/SEO";
import { Stats } from "@/components/site/Stats";
import { Charity } from "@/components/site/Charity";
import { Link } from "react-router-dom";
import { Button } from "@/components/ui/button";

    ...
    <div className="container-pro">
      ...
      <div className="mb-12 md:mb-16 max-w-3xl">
        ...
        <p className="mt-6 text-foreground/75 text-base md:text-lg leading-relaxed">
          These journeys reflect structured development pathways — combining
          training, exposure, and long-term player development systems designed
          to prepare athletes for professional football environments.
        </p>
      </div>
